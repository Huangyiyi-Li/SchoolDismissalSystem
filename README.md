...
* **仰邦 LED 状态屏**:
  ...
  * 每屏可配置显示 1–6 个年级，超出后由电脑按设置间隔翻页；刷卡或手动放学后显示“放学中”。
  * 控制卡 IP、端口、学校标题、每屏年级数和翻页间隔均可在设置页修改，并提供连接测试和测试画面。
...
* `led_grades_per_page`: 每屏显示的年级数，可设为 `1-6`，默认 `2`。
...
3. **管理**:
    ...
    * 首次接屏先点击“测试连接”，成功后点击“发送测试画面”；测试结束可点击“清空状态/恢复原节目”。
